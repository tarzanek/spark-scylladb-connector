...
object Artifacts {
  ...
  val cassandraDriver         = "com.scylladb"  % "scylla-driver-core"  % CassandraDriver driverExclusions() // ApacheV2
  val cassandraDriverMapping  = "com.scylladb"  % "scylla-driver-mapping"  % CassandraDriver driverExclusions() // ApacheV2
